...
const SelectTrigger = <T extends ValidComponent = "button">(
    ...
    return (
        <SelectPrimitive.Trigger
            class={cn(
                "flex h-10 w-full items-center justify-between rounded-md border border-input bg-transparent px-3 py-2 text-sm outline-offset-background placeholder:text-muted-foreground focus:outline-hidden focus:outline-2 focus:outline-ring focus:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
                local.class
            )}
            {...others}
        >
