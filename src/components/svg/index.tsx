...
export const SpinnerIcon: Component<{
    ...
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="title-04a desc-04a" aria-live="polite" aria-busy="true" class={`${props.class ?? "size-6"} animate animate-spin`}>
